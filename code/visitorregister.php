...
<html>
	<head>
		<title>Job League - Applicant Registration</title>
		<meta charset="utf-8" />
						...
						<div class="row 200%">
							<div class="8u 12u(mobile)" id="content">
								<article id="main">
									...
									<p>Please fill in your personal detail in below.</p>
									<section>
										 <form action="visitorregister2.php" method="post" enctype="multipart/form-data">
										<input type='text' name='fullname' placeholder="User Account" class="textox"></br>
										<input type="email" name="email" placeholder="Email" class="textox"/></br>
										<input type='text' name='phone' placeholder="Phone" class="textox"></br>
										<input type='password' name='password' placeholder="Password" class="textox"></br>
										<input type='password' name='cpassword' placeholder="Confirm Password" class="textox"></br>
										<input type="submit" value="Register"> <input type='reset' value='Clear'/></br>
										</form>
									</section>
								</article>
							</div>
