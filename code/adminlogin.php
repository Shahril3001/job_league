						...
						<div class="row 200%">
							<div class="8u 12u(mobile)" id="content">
								<article id="main">
									...
									<section>
										 <form name="Login" method="post" action="advalidate.php">
											<input type='text' name='username' placeholder="User Name" class="textox"></br>
									...
									<p style="color:red;">(Note: This site can be access by the administrator and staff only.)</p>
									</section>
								</article>
							</div>
