			...
			<!-- Header -->
				<div id="header">
					...
					<!-- Inner -->
						<div class="inner">
							<header>
								<h1><a href="index.html" id="logo">Job League</a></h1>
							</header>
						</div>
						...
						<div class="row 200%">
							<div class="8u 12u(mobile)" id="content">
								<article id="main">
									...
									<p><a href="addproject(a).php"><input type="button" value="Add Project" /></a></p>
									<section>
										    <?php
...
<td width=200><center>
<p><a href='update(project).php?projectID=".$item['projectID']."'><input type='button' name='apply' value='Update'></a></p>
<p><a href='remove(project).php?projectID=".$item['projectID']."'><input type='button' name='apply' value='Remove'></a></p></br></center>
</td>
</tr>
";
}
