...
<html>
	<head>
		<title>Job League - Freelancer Login</title>
		<meta charset="utf-8" />
					...
					<div class="container">
						<div class="row 200%">
							<div class="8u 12u(mobile)" id="content">
								<article id="main">
									<header>
										<h2>Freelancer Login (INVALID)</h2>
									</header>
									<p>Please enter your email and password to login.</p>
									<section>
										 <form name="Login" method="post" action="cusvalidate.php">
										<input type='text' name='email' placeholder="Email" class="textox"></br>
										<input type='password' name='password' placeholder="Password" class="textox"></br></br>
										<input type="submit" value="Login"> <input type='reset' value='Clear'/></br></br>
										</form>
										</br>
									<p>Don't have account yet. Please click <a href="visitorregister.php">Register</a> to create new account.</p>
									</section>
								</article>
							</div>
